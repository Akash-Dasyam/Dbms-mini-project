...
<fieldset>
    ...
    <input type="text" id="fname" name="firstname" autocomplete="off" placeholder="First name.."  autocomplete="off">
	...
	<input type="date" id="dob" name="bday"  ></br>
	...
	<input type="text" id="address" name="adress" placeholder="Address.." ></br>
