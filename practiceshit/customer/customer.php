...
$framelink = "http://localhost/practiceshit/customer/pro.php";
...
<div class="form1">
<ul>
  <li><a class="active" href="#home">Create a new Customer</a></li>
...
<div class="form2">
<iframe src='<?php echo $framelink; ?>' width="100%" height="75%" style="border-color:green; border-width:10px">
